...
pub fn executar_o_exercício_x(número_do_exercício: u32, cabeçalho_do_programa: &String) {
    if número_do_exercício == 74 {
        ex_074::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 73 {
        ex_073::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 72 {
        ex_072::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 71 {
    ...
    } else if número_do_exercício == 69 {
        ex_069::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 68 {
        ex_068::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 67 {
        ex_067::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 66 {
        ex_066::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 65 {
        ex_065::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 64 {
        ex_064::rodar_o_exercício(
            &cabeçalho_do_programa
        );
        
    } else if número_do_exercício == 63 {
    ...
    } else if número_do_exercício == 61 {
        ex_061::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 60 {
        ex_060::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 59 {
        ex_059::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 58 {
        ex_058::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 57 {
        ex_057::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 56 {
        ex_056::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 55 {
        ex_055::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 54 {
        ex_054::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 53 {
        ex_053::rodar_o_exercício(
            &cabeçalho_do_programa
        );

    } else if número_do_exercício == 52 {
