pub fn lista_de_exercícios(
    ...
    let exercícios_descrições: Vec<&str> = vec![
        ...
        "Um programa que lê um número inteiro e mostra na tela o seusucessor e seu antecessor.",
        ...
        "m programa que lê um número inteiro x e mostra no terminal os x primeiros elementos da Sequência de Fibonacci.\n\n Exemplo:\n0 -> 1 -> 1 -> 2 -> 3 -> 5 -> 8",
